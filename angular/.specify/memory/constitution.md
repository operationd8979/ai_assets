...
Modified principles:
- Angular Workspace Source: clarified through synchronized templates
- Co-Located Angular Unit Tests: clarified through synchronized templates
- Karma/Jasmine Validation: clarified through synchronized templates
- Precise Spec-Driven Tasks: clarified through synchronized templates
- Independent User Story Delivery: clarified through synchronized templates
Added sections:
- None
Removed sections:
- None
...
clarifications. Version 1.0.1 clarifies synchronization of the constitution,
constitution template, and feature specification template without changing the
core Angular testing policy.
